<?php
	...
	if(empty($l1))$l1='Not updated'; if(empty($l2))$l2='Not updated';
	...
	{
		header ("Location: ../edit_property_admin.php?a=2i5&b=$id");
	}
	else
	{
		$run->db_open();
		...
		header ("Location: ../edit_property_admin.php?a=2k9&b=$id");
		$run->db_close();
	}
?>
