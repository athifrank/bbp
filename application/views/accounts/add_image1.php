  ...
  <div id="parea">
        ...
        <div class="display_msg">
			...
			/* 	$a=$_REQUEST['a']; 
				...
				$run->db_open();
				$query=mysql_query("SELECT id,tit FROM properties WHERE uid='admin' ORDER BY id DESC LIMIT 1");
			...
			<div id="h1" class="red"><?php echo $this->session->flashdata('chmod');?></div>
                ...
                <table height="150" width="400">
                	<tr>
                        ...
                        <td width="300">
                        <form action="<?=site_url();?>user_upload_file1" method="post" enctype="multipart/form-data">
                   ...
                   <tr>
                   <td><form action="<?=site_url();?>skip_upload1/index/<?php foreach($row as $data) $id=$data['id'];  echo $id;?>" method="post"><input type="submit" value="Finish"/></form></td></tr>
                  </table>
