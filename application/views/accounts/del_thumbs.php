...
<div id="content" class="wrapper">
  <div id="parea">
      ...
      <div style="border:#CCCCCC 1px solid; width:450px; margin:40px auto; height:100px;">
		...
		/* 	$id=$_REQUEST['b'];
			$run->db_open();
		 	$query = mysql_query("SELECT fname FROM image where id=$id");
			$run->db_close();
		 	$row = mysql_fetch_array($query);
			$name=$row['fname']; */
		?>
        	Are you sure to remove the thumbnail: <?php echo $name; ?> 
        </div>
        <div align="center"><form action="<?=site_url();?>manage_thumbnails/del_action"><table width="144" height="64" >
