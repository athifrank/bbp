...
<div id="content" class="wrapper">
  <div id="parea">
    	<div class="ptitle">Manage Updates</div>
    	<div class="pcontent">
                ...
                <form action="<?=site_url();?>manage_updates/add_updates" method="post">
			    <table width="980">
        		<tr>
                  <td width="150">
                  ...
                  <td width="310"><input type="text" style="width:300px;" name="msg"
					...
					onBlur="if(this.value=='')this.value='Property Updates'" 
					onfocus="if(this.value=='Property Updates')this.value=''" /></td>
                        ...
                        <?php
							...
							foreach($ro as $row)
                            {
                                ...
                                echo '<tr><td class="td" width="50">'.$sno.'</td>
                                      ...
                                      <td class="td" width="50"><a href="'.site_url().'manage_updates/view_update/'.$id.'"><img src="'.base_url().'assets/images/'.$type.'.png" title="View Message" /></a></td>
                                      <td class="td" width="50"><a href="'.site_url().'manage_updates/edit_update/'.$id.'"><img src="'.base_url().'assets/images/edit.png" title="Edit Message" /></a></td>
                                      <td class="td" width="50"><a href="'.site_url().'manage_updates/delete/'.$id.'"><img src="'.base_url().'assets/images/delete.png" title="Delete Message"/></a></td></tr>';
								$sno++;
                            }
