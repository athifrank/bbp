...
<div id="content" class="wrapper">
  <div id="parea">
    	<div class="ptitle">Add Projects <input type="button"  onclick="window.location.href='<?=site_url();?>featured_projects'"/></div>
    	<div class="pcontent">
				...
				?>
				<div class="red" id="h1"><?php echo $this->session->set_flashdata('server');?></div>
                </div>
                
          		<div style="width:750px; margin:0 auto;">
                <form action="<?=site_url();?>featured_projects/add_action" method="post" name="myform" id="myform">
			    <table width="750" height="500" align="center">
        		<tr>
                  <td width="100" class="tdname">Project title*</td>
                   <td ><input type="text" style="width:600px;" name="tit" class="tdbox" /></td>
                  </tr>
                  
                  <tr>
                  	<td class="tdname">Location*</td>
                  	<td><input type="text" class="tdbox" id="location_list" name="loc" style="width:600px;"/></td>
                  </tr>
                  ...
                  <tr>
                  	<td colspan="2"><textarea id="elm1" name="text" style="width: 700px; height: 300px;" class="tinymce"></textarea></td>
                  </tr>
