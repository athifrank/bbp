...
<!----- Header_2 ends ----->
<div id="content" class="wrapper" style="height:930px;">
  <div id="parea">
        	<div class="ptitle">Property Details <input type="button"  onclick="window.location.href='<?=site_url();?>manage_properties'"/></div>
            <div class="pcontent">
              ...
              <?php 
				...
				$face=$row['face'];
		?>
        <form action="<?=site_url();?>edit_property/edit/<?php echo $id; ?>" method="post" name="myform" id="myform"/>
                	...
                	<tr>
                    	<td>
                        	<table width="400" height="350">
                          	<tr><td height="260">
                            <a rel="example_group" href="<?=base_url();?>update_image/index/<?php echo $id; ?>">
