  ...
  <div id="parea">
      ...
      <div style="border:#CCCCCC 1px solid; width:450px; margin:40px auto; height:100px;">
        ...
        <?php
			/* $id=$_REQUEST['b'];
			$run->db_open();
		 	$query = mysql_query("SELECT * FROM location_list where id=$id");
			$run->db_close();
		 	$row = mysql_fetch_array($query);
			$name=$row['name']; */
		?>
        	Are you sure to delete the location : <?php echo $name; ?> 
        </div>
        <div align="center"><form action="<?=site_url();?>manage_location/del_action"><table width="144" height="64" >
