  ...
  <div id="parea">
      ...
      <div style="border:#CCCCCC 1px solid; width:450px; margin:40px auto; height:100px;">
        ...
        <?php
			...
			$msg=substr($row['tit'], 0, 25); */
		?>
        	Are you sure to delete the message : <?php echo $msg.'...'; ?> 
        </div>
        <div align="center"><form action="<?=site_url();?>property_documents_admin/del_action"><table width="144" height="64" >
