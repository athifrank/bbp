...
<div id="content" class="wrapper">
  <div id="parea">
        	<div class="ptitle">Edit Details<input type="button"  onclick="window.location.href='<?=site_url();?>manage_news'"/></div>
            <div class="pcontent">
      ...
      <div>
        <div style="margin:0px auto; width:500px;">
        	<form action="<?=site_url();?>manage_news/edit_action" method="post">
