	...
	<?php	/*  <div class="display_msg">
      ...
      <div style="border:#CCCCCC 1px solid; width:450px; margin:40px auto; height:100px;">
		<div style="background-color:#f0f0f0; height:20px; padding:5px; border-bottom:#CCCCCC 1px solid;">
			...
			//$val = $_REQUEST['del'];
		?>
        	Are you sure to delete these Properties 
        </div>
        <div align="center"><form method = "post" action="<?=site_url();?>del_property_multi/delete"><table width="144" height="64" >
       <tr><td><input type="submit" value=" Yes "/><?php foreach($val as $value) { echo '<input type="hidden" value='.$value.' name="vel[]" /> ' ;}?>
