 ...
 <br />
  <div id="parea">
            ...
            <div class="pcontent">
              ...
              <?php 
				$run->db_open();
		 		$query = mysql_query("SELECT * from properties p,image i WHERE p.id=i.pid and p.id=$id");
				$run->db_close();
                	...
                	<tr>
                    	<td>
                        	<table width="400" height="350">
                          	<tr><td height="260">
                            <a rel="example_group" href="accounts/savefiles/<?php echo $fname; ?>">
                            <img src="accounts/savefiles/<?php echo $fname;?>" height="260" width="380" title="Click to zoom" /></a></td></tr>
                    		<tr><td height="25">Name & Contact Details</td></tr>
                            <tr><td><?php echo $run->string_br($nc);?></td></tr>
                            </table>
                        </td>
                        <td>
                        	<table width="400" height="350">
								...
								echo "Contact for price"; else echo $run->money($price);?></td></tr>
