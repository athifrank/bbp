...
class Update_image1 extends CI_Controller {
	...
	{  
	  ...
	  $this->load->view('accounts/update_image1',$data);
	}
  ...
  $title = $row['tit'];
   ...
   if(move_uploaded_file($_FILES['userfile']['tmp_name'],$upload_path . $filename))
   {
	   ...
	   redirect("edit_property/admin_edit/$pid");
	   //echo 'Your file upload was successful, view the file <a href="' . $upload_path . $filename . '" title="Your File">here</a>'; // It worked.
   }    
   else {
	   $this->session->set_flashdata('try','Please Try again Later');
	   redirect("edit_property/admin_edit/$pid");   //header("Location: $page?a=e12");//echo 'There was an error during the file upload. Please try again.'; // It failed :(.
   }       
